...
def train(net, data_loader, loss_fn, experiment_name, valdir):
    ...
    for epoch in range(epochs):
        ...
        if current_nk > nk_best:
            torch.save(net.state_dict(), os.path.join("weights", "squeezenet_classTransferTriphardTransfer_triplet_hardest_best.pth"))
            nk_best = current_nk
        torch.save(net.state_dict(), os.path.join("weights", "squeezenet_classTransferTriphardTransfer_triplet_hardest_last.pth"))
